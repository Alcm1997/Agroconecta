...
// Buscar por nombre y departamento (insensible a mayúsculas)
exports.getDistritoByNombre = async (nombre, id_departamento) => {
  const result = await pool.query(
    'SELECT * FROM distrito WHERE UPPER(nombre_distrito) = UPPER($1) AND id_departamento = $2',
